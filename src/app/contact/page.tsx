...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // In a real app, you would send this data to your server/API
        ...
        <div className="max-w-lg mx-auto md:max-w-none md:grid md:grid-cols-2 md:gap-8">
          ...
          >
            ...
            <p className="mt-3 text-lg text-gray-500">
              Des questions, des commentaires ou besoin d'aide ? N'hésitez pas à nous contacter.
            </p>
            ...
            <div className="mt-9">
              <div className="flex">
                ...
                <div className="ml-3 text-base text-gray-500">
                  ...
                  <p className="mt-1">Du lundi au samedi, 10h-19h</p>
                </div>
              </div>
              ...
              <div className="mt-6 flex">
                ...
                <div className="ml-3 text-base text-gray-500">
                  ...
                  <p className="mt-1">66000 Perpignan</p>
                </div>
              </div>
